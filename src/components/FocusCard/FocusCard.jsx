...
function FocusCard() {
  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap overflow-y-scroll bg-gradient-to-b from-[#303030] to-[#121212] h-screen mt-16">
        {/*  MAPPATURA  */}
        {canzoni.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <div>
                <div className="w-36 h-36 relative rounded-lg mb-2 shadow-md  shadow-[#20202088]">
                  <img
                    className="relative"
