  ...
  return (
    <>
      <div className="bg-gradient-to-b from-[#303030] to-[#121212] h-screen">
        ...
        <div className="w-[170px] h-[250px] bg-griginoBg hover:bg-[#404040] group duration-300 ease-in-out rounded-lg p-3 flex flex-col gap-1 cursor-pointer m-2">
          <div>
            <div className="w-36 h-36 relative rounded-lg mb-2 bg-red-500 shadow-md  shadow-[#20202088]">
              ...
              <img
                ...
                alt=""
                className="h-12 absolute bottom-0 right-2 opacity-0 group-hover:opacity-100 group-hover:bottom-3 group-hover:rounded-full group-hover:shadow-md group-hover:shadow-[#0000004e] transition-all duration-500"
              />
