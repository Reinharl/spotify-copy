    ...
    return (
        <>
            ...
            >
                ...
                <div className="mt-16 flex  justify-center md:justify-between p-4">
                    <h1 className="text-white font-bold md:text-lg lg:text-3xl">
                        Top 10 Songs Spotify
                    </h1>
                    {/*<h2 className="text-grigioTesto text-sm font-bold cursor-pointer"> Mostra tutto </h2> */}
                </div>
                <div className="flex flex-wrap justify-center md:justify-start  ">
                    ...
                    hover:scale-110 transition-all duration-500"
                                ...
                                {/* <p className="text-xs text-grigioTesto"> </p> */}
                            </div>
                        );
                    })}
                </div>
